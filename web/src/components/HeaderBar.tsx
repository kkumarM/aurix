      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="text-xl font-semibold text-slate-100 tracking-wide" style={{ letterSpacing: '0.08em' }}>GPARX</div>
            <div className="text-xs text-slate-400">GPU Performance Analysis &amp; Reasoning eXplorer</div>
          </div>
        </div>
...
function GparxMark() {
  return (
    <svg width="42" height="42" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="GPARX logo">
