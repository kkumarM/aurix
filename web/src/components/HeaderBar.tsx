...
export default function HeaderBar({ backendUrl, onOpenTimeline, hasRun }: { backendUrl: string; onOpenTimeline: () => void; hasRun: boolean }) {
  ...
  return (
    <header className="sticky top-0 z-30 bg-slate-950/80 backdrop-blur px-4 lg:px-6 py-3 flex items-center justify-between border-b border-slate-800/80">
      <div className="flex items-center gap-3">
        <AurixMark />
        <div className="leading-tight">
          <div className="text-xl font-semibold text-slate-100 tracking-wide" style={{ letterSpacing: '0.06em' }}>AURIX</div>
